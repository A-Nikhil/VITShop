<?php
// checking if a login already exists
session_start();
error_reporting(0);
                    ...
                    <div id="hero" class="homepage-slider3">
                        <div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
                            <div class="full-width-slider">
                                <div class="item" style="background-image: url(assets/images/sliders/slider123.png);">
                                    <!-- /.container-fluid -->
                                </div><!-- /.item -->
                                ...
                                <div class="hidden-md col-sm-4 col-lg-4">
                                    <div class="info-box">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-10">
                                                <h4 class="info-box-heading orange">Secure Delivery</h4>
                                            </div>
                                        </div>
