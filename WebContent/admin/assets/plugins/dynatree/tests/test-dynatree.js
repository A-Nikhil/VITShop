    ...
    test("Create dynatree", function () {
        $("#tree").dynatree({
            children: [
                {
                    key: "_1",
                    title: "Lazy Add 100 nodes (flat, force update)...",
                    isFolder: true,
                    isLazy: true,
                    mode: "add100_flat_u"
                },
                ...
                {
                    key: "_3",
                    title: "Lazy Add 1.000 nodes (flat)...",
                    isFolder: true,
                    isLazy: true,
                    mode: "add1000_flat"
                },
                {
                    key: "_4",
                    title: "Lazy Add 1.000 nodes (deep)...",
                    isFolder: true,
                    isLazy: true,
                    mode: "add1000_deep"
                },
                {
                    key: "_5",
                    title: "Lazy Add 10.000 nodes (deep)...",
                    isFolder: true,
                    isLazy: true,
                    mode: "add10000_deep"
                },
